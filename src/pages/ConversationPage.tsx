...
export function ConversationPage() {
  ...
  return <div className="learn-page"><PageHeading eyebrow={`CONVERSAÇÃO ${variant === 'british' ? 'BRITÂNICA' : 'AMERICANA'} · OUÇA, FALE, TENTE DE NOVO`} title="Seu inglês merece sair do papel." text={`Prepare uma situação, pratique com uma voz ${variantMeta.shortLabel === 'Reino Unido' ? 'britânica' : 'americana'} e leve ao ChatGPT um tutor instruído a manter vocabulário, ortografia e pronúncia de ${variantMeta.shortLabel}.`} />
